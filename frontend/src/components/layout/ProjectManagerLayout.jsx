...
export function ProjectManagerLayout({ title, description, children }) {
  ...
  const workspaceLabel = "Project manager";

  return (
    <div className="min-h-screen bg-surface lg:flex">
      <ProjectManagerSidebar userRole={user?.role} />
...
export function ProjectManagerPlaceholder({ title, description, children }) {
  return (
    <ProjectManagerLayout title={title} description={description}>
      {children ?? (
